...
// --- 配置预设 (你可以修改这里的参数来改变效果) ---
const options = {
    onSpeedUp: () => { },
    onSlowDown: () => { },
    distortion: 'turbulentDistortion', // 扭曲类型
    length: 400,
    roadWidth: 10,
    islandWidth: 2,
    lanesPerRoad: 3,
    ...
    colors: {
        ...
        leftCars: [0xd856bf, 0x6750a2, 0xc247ac], // 左侧车流颜色 (粉/紫)
        rightCars: [0x03b3c3, 0x0e5ea5, 0x324555], // 右侧车流颜色 (青/蓝)
        sticks: 0x03b3c3, // 侧边光柱颜色
    }
};
...
(function () {
    ...
    config.distortion = distortions[config.distortion]; // 映射 distortion 字符串到对象
